...
class maps:
	...
	def __init__(self, centerLat, centerLng, zoom,locations ):
	...
	def draw(self, htmlfile):
		...
		f.write('setMarkers(map,beaches)\n')
		f.write('\t}\n')
		f.write('var beaches = ' + self.markers + '\n')
		f.write('function setMarkers(map, locations) {\n')
		f.write('\tfor (var i = 0; i < locations.length; i++) {\n')
		f.write('\t\tvar beach = locations[i];\n')
		f.write('\t\tvar myLatLng = new google.maps.LatLng(beach[1], beach[2]);\n')
		f.write('\t\tvar marker = new google.maps.Marker({\n')
		f.write('\t\t\tposition: myLatLng,\n')
		f.write('\t\t\tmap: map,\n')
		f.write('\t\t\t title: beach[0],\n')
		f.write('\t\ticon: new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|" + beach[3])')
		f.write('});\n')
		f.write('}\n')
		f.write('}\n')
		f.write('</script>\n')
	...
	def drawmap(self, f):
		...
		f.write('\t\t\tstreetViewControl: false \n')
		f.write('\t\t};\n')
